        ...
        <div className="container">
          <div className="relative -mx-4 flex items-center justify-between">
            <div className="w-60 max-w-full px-4 xl:mr-12">
              ...
              >
                <img src="/images/logo/logo2.png" style={{height:"60px", width:"60px"}}     className="hidden w-full dark:block"/>
                <img src="/images/logo/logo1.png" style={{height:"60px", width:"60px"}}      className="w-full dark:hidden"/>
            ...
            <div className="flex w-full items-center justify-between px-4">
              <div>
                ...
                >
                  <ul className="block lg:flex lg:space-x-12 sm:ml-[388px] ">
